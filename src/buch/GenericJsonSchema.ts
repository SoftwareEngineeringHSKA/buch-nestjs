...
export interface GenericJsonSchema {
    ...
    // -------------------------------------------------------------------------
    /**
     * This is important because it tells refs where the root of the document is
     * located
     */
    $id?: string;
    /**
     * It is recommended that the meta-schema is included in the root of any json
     * schema and must be a uri
     */
    $schema?: string;
    /**
     * Title of the schema
    ...
    /**
     * The keys that can exist on the object with the json schema that should
     * validate their value
     */
    properties?: Record<string, GenericJsonSchema>;
    /**
     * The key of this object is a regex for which properties the schema applies
     * to
     */
     ...
     * be present. If the value is a JSON Schema then it must also be valid for
     * the object if the key is present.
     */
    ...
    // -------------------------------------------------------------------------
    /**
     * Enumerates the values that this schema can be (e.g. {"type": "string",
     * "enum": ["red", "green", "blue"]})
     */
    enum?: any[];
    /**
     * The basic type of this schema, can be one of [string, number, object,
     * array, boolean, null] or an array of the acceptable types
     */
    type?: string[] | string;
