...
// import { BuchModel } from '../buch/entity';
...
//     const collections = await BuchModel.db.db
//         .listCollections({ name: BuchModel.collection.name })
//         .toArray();
//     if (collections.length > 0) {
//         await BuchModel.collection.drop();
//     }

//     const collection = await BuchModel.createCollection();
//     logger.warn(
//         'Die Collection %s wurde neu angelegt.',
//         collection.collectionName,
//     );

//     const insertedDocs = await BuchModel.insertMany(testdaten, { lean: true });
